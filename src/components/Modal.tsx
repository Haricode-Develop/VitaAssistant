...
export default function Modal({
                                  open, onClose, title, children, primaryLabel = "Guardar", onPrimary
                              }: { open: boolean; onClose: () => void; title: string; children: React.ReactNode; primaryLabel?: string; onPrimary?: () => void; }) {
    if (!open) return null;
    return (
